...
const pages = [
  ...
  { slug: "privacy-policy", title: "Privacy Policy", meta_title: "Privacy Policy | ICE", meta_description: "How International Computer Exchange collects, uses, and protects personal information and SMS opt-in records.", page_type: "legal", is_published: true, sort_order: 49 },
...
const sections = [
  ...
  { slug: "subscribe", key: "consent", type: "content", order: 30, content: { prefix: "By submitting, you consent to the selected communications.", privacy_label: "Read our privacy notice", privacy_href: "/privacy-policy", suffix: "." } },
