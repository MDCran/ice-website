  ...
  return (
    ...
    >
      <svg viewBox="0 0 300 300" className="w-full h-full">
        ...
        <text x="52" y="89" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.4)">Firewall OK</text>
        <circle cx="45" cy="97" r="2.5" fill="#f59e0b" opacity="0.7">
          <animate attributeName="opacity" values="0.5;1;0.5" dur="1.5s" repeatCount="indefinite" />
        </circle>
        <text x="52" y="100" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.4)">Login anomaly</text>
        ...
        <text x="52" y="111" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.4)">DNS normal</text>
        ...
        <text x="172" y="89" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.4)">IDS Active</text>
        ...
        <text x="172" y="100" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.4)">IPS Active</text>
        ...
        <text x="172" y="111" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.4)">Scan running</text>
        ...
        <text x="45" y="152" fontSize="7" fontFamily="monospace" fill="rgba(255,255,255,0.5)">Protected: <tspan fill="#10b981">247</tspan></text>
        <text x="45" y="164" fontSize="7" fontFamily="monospace" fill="rgba(255,255,255,0.5)">At Risk:   <tspan fill="#f59e0b">3</tspan></text>
        <text x="45" y="176" fontSize="7" fontFamily="monospace" fill="rgba(255,255,255,0.5)">Offline:   <tspan fill="rgba(255,255,255,0.3)">0</tspan></text>
        ...
        {/* Mini progress bar */}
        <rect x="165" y="148" width="88" height="6" rx="3" fill="rgba(255,255,255,0.05)" />
        ...
        {/* Mini bar 2 */}
        <rect x="165" y="170" width="88" height="6" rx="3" fill="rgba(255,255,255,0.05)" />
        ...
        <g clipPath="url(#logClip)">
          <g>
            ...
            {/* Log entries */}
            <text x="45" y="228" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.3)">
              <tspan fill="rgba(4,155,251,0.5)">09:41:23</tspan> Auth success user:admin
            </text>
            <text x="45" y="240" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.3)">
              <tspan fill="rgba(4,155,251,0.5)">09:41:19</tspan> Firewall rule matched #447
            </text>
            <text x="45" y="252" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.3)">
              <tspan fill="rgba(245,158,11,0.6)">09:41:15</tspan> Brute force attempt blocked
            </text>
            <text x="45" y="264" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.3)">
              <tspan fill="rgba(4,155,251,0.5)">09:41:11</tspan> TLS handshake completed
            </text>
            <text x="45" y="276" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.3)">
              <tspan fill="rgba(4,155,251,0.5)">09:41:08</tspan> Policy update applied
            </text>
            {/* Duplicate for seamless loop */}
            <text x="45" y="288" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.3)">
              <tspan fill="rgba(4,155,251,0.5)">09:41:23</tspan> Auth success user:admin
            </text>
            <text x="45" y="300" fontSize="6" fontFamily="monospace" fill="rgba(255,255,255,0.3)">
              <tspan fill="rgba(4,155,251,0.5)">09:41:19</tspan> Firewall rule matched #447
            </text>
          </g>
        </g>
