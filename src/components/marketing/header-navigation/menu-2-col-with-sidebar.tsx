...
import { BookClosed, ChevronRight, FileCode01, Flag04, Folder, MessageCircle01, PlayCircle, Stars02, Users01 } from "@untitledui/icons";
                    ...
                    <div className="flex flex-col items-start bg-secondary pt-5 pb-6 md:rounded-2xl md:p-6 md:pr-8">
                        <div className="flex w-full justify-between">
                            ...
                            <div className="hidden px-4 leading-none md:inline-block md:px-0">
                                <Button color="link-color" size="sm" href="/" iconTrailing={ChevronRight}>
                                    All video tutorials
                                </Button>
                            </div>
                        </div>
