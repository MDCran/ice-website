    ...
    return (
        <div className="bg-primary">
            <div className="mx-auto grid max-w-container grid-cols-1 gap-16 bg-primary px-4 pb-16 md:px-8 md:pb-24 lg:grid-cols-2 lg:gap-16 lg:pt-16">
                <img className="hidden h-160 object-cover lg:block" src="https://www.untitledui.com/marketing/podcast-girl-3.webp" alt="Podcast girl" />

                <div className="flex flex-col justify-center gap-16 pt-16 lg:gap-32 lg:pt-32">
                    <div className="flex flex-col items-start">
                        <BadgeGroup size="md" addonText="12 Jan 2027" color="brand" theme="modern" className="pr-3" iconTrailing={null}>
                            Customer Success
                        </BadgeGroup>
                        <h1 className="mt-4 text-display-md font-semibold text-primary md:text-display-lg">Podcast: Creating a better CX Community</h1>
                        <p className="mt-4 text-lg text-tertiary md:mt-8 md:text-xl">
                            Starting a community doesn't need to be complicated, but how do you get started? Learn how with the best.
                        </p>
                        <div className="mt-8 flex items-center gap-3 md:mt-12">
                            ...
                            />
                            <div>
                                <p className="text-md font-semibold text-primary">Orlando Diggs</p>
                    ...
                    <div className="mx-auto max-w-prose lg:max-w-180">
                        <div className="prose-centered-quote mx-auto prose md:prose-lg">
                            ...
                            <figure>
                                <img className="h-60 md:h-96" src="https://www.untitledui.com/marketing/girl-4.webp" alt="Girl with a camera" />
                                <figcaption>
                                    <Link01 className="size-4 text-utility-neutral-400" />
                                    <span>
