          ...
          <div className="grid lg:grid-cols-[220px_1fr] gap-10">
            ...
            >
              ...
              <div id="sign-up" className="mb-10 scroll-mt-28">
                <h3 className="text-lg font-semibold text-sky-400 mb-4">{sectionOverrides["sign-up"]?.title ?? "How You Can Sign Up"}</h3>
              ...
              <div id="frequency" className="mb-10 scroll-mt-28">
                <h3 className="text-lg font-semibold text-sky-400 mb-4">{sectionOverrides["frequency"]?.title ?? "Frequency & Types of Messages"}</h3>
                <p className="text-sm text-slate-300 leading-[1.8] mb-3">{sectionOverrides["frequency"]?.content ?? "Message frequency varies. You may receive:"}</p>
              ...
              <div id="carrier" className="mb-10 scroll-mt-28">
                <h3 className="text-lg font-semibold text-sky-400 mb-4">{sectionOverrides["carrier"]?.title ?? "Carrier Compliance"}</h3>
                <p className="text-sm text-slate-300 leading-[1.8]">
              ...
              <div id="questions" className="mb-8 scroll-mt-28">
                <h3 className="text-lg font-semibold text-sky-400 mb-4">{sectionOverrides["questions"]?.title ?? "Questions?"}</h3>
                <p className="text-sm text-slate-300 leading-[1.8]">
